...
export default function Workouts() {
    ...
    // Note: Using React.ChangeEvent to avoid direct import deprecation issues
    ...
    // Note: Using React.FormEvent to avoid direct import deprecation issues
                            ...
                            <div key={session.id} className="bg-white rounded-lg shadow-sm p-5 border border-gray-200">
                                ...
                                <table className="w-full text-sm text-left text-gray-600">
                                    ...
                                    {session.exercise_logs.map((log, i) => {
                                        // Determine how to display the weight visually
