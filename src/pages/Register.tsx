            ...
            <div className="flex h-screen items-center justify-center bg-gray-100">
                <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-md text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        We have sent a verification link to <strong className="text-gray-800">{email}</strong>.
        ...
        <div className="flex h-screen items-center justify-center bg-gray-100">
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
                ...
                <form onSubmit={(e) => void handleRegister(e)} className="flex flex-col gap-4">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-blue-600 text-white font-bold py-3 rounded hover:bg-blue-700 transition shadow-sm mt-2"
                    >
                        Register
                    </button>
                </form>
